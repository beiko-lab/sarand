...
class BaktaResult:
    ...
    def get_for_sarand(self):
        ...
        for feature in self.data['features']:
            # TODO: Locus tag is different from Prokka
            # TODO: Length is off by 1 base, maybe exclusive bounds?
            # TODO: product name is different (more verbose than prokka)
            # TODO: Remove prokka_gene_name once implemented
            # TODO: The stop/start are flipped for reverse strand as per the previous implementation
            out.append({
                "locus_tag": feature['locus'],
                "gene": feature['gene'] or '',  # TODO: This matches the expected output
                "length": str((feature['stop'] - feature['start']) + 1),
                # TODO: This matches the expected output but should remain int
...
class Bakta:
    ...
    @classmethod
    def run_sarand(cls, genome: Path, prefix: str, out_dir: Path, db: Path):
        params = BaktaParams(
            genome=genome,
            db=db,
            prefix=prefix,
